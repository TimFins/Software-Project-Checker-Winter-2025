...
####################################
# 2. Creating an PriorityQueueNode #
####################################
...
root.display_priority_queue_image(
    "2.1 This is the initial priority queue\ncontaining just '5'.")
_wait_for_user_confirmation("2.1")


###################################
# 3. Modifying the priority queue #
###################################
...
root.display_priority_queue_image(
    "3.1 Now a left child was added.")

...
root.display_avl_image(
    "3.2 Two nodes were added and the balance values were adjusted accordingly.")
_wait_for_user_confirmation("3.2")


#################################################
# 4. Creating a copy and comparing for equality #
#################################################
...
print("4.1 root.get_right_child() == root_copy.get_right_child() =",
...
_wait_for_user_confirmation("4.1")

print("4.2 root == root_copy =", root == root_copy)
...
_wait_for_user_confirmation("4.2")
...
print("4.3 root.is_equal_including_subtrees(root_copy) =",
...
_wait_for_user_confirmation("4.3")
